            ...
            <div class="panel-body">
                ...
                <div class="row" ng-controller="SearchItemCtrl">
                    ...
                    <div class="col-md-3">
                        ...
                        <td>@{{item.item_name}}</td><td><button class="btn btn-primary btn-xs" type="button" ng-click="addReceivingTemp(item,newreceivingtemp)">اضافة</button></td>
                    ...
                    <div class="col-md-9">
                        ...
                        <table class="table table-bordered">
                            ...
                            <td>@{{newreceivingtemp.item_id}}</td>
                                ...
                                <td>@{{newreceivingtemp.item.cost_price | currency :"EGP"}}</td>
                                ...
                                <td>@{{newreceivingtemp.item.cost_price * newreceivingtemp.quantity | currency :"EGP"}}</td>
                                <td><button class="btn btn-danger btn-xs" type="button" ng-click="removeReceivingTemp(newreceivingtemp.id)">ازالة</button></td>
                            </tr>
                        </table>
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><b>@{{sum(receivingtemp) | currency :"EGP"}}</b></p>
                                        </div>
                                    </div>
                                    <div>&nbsp;</div>
                                    <div class="form-group">
